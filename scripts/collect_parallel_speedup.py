...
datasets = ["salmonella_512", "random_512"]
threads_list = [1,2,4,8,16,32]

print("dataset\tn_threads\ttime_seconds\tmem_bytes")
for dataset in datasets:
    for t in threads_list:
        filename = f"logs/{dataset}_themisto_t{t}.log"
        res = parse_time_output(open(filename).readlines())
        print("{}\t{}\t{}\t{}".format(dataset, t, res["elapsed_seconds"], res["max_rss_bytes"]))
