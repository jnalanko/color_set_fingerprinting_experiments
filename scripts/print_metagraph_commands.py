...
for i in range(1, max_power+1):
    ...
    # Build DBG
    print(f"cat {input} | /usr/bin/time -v xargs ~/code/metagraph/metagraph_DNA build -k 31 -o {output} -p 32 --mem-cap-gb {mem_cap_gb} --verbose --mode canonical 2>&1 | tee {log_output}")
